...
def lambda_handler(event, context):
    ...
    # Processar até o ano atual + 1 para pegar virada de ano
    ...
    # --- ETAPA 3: Disparar Workflow do Glue ---
    try:
        glue = boto3.client('glue')
        glue.start_workflow_run(Name='sentinel-gold-workflow')
        print("SUCESSO: Workflow sentinel-gold-workflow disparado pela Lambda!")
    except Exception as e:
        print(f"ERRO ao disparar Workflow: {e}")
